...
1. **User Model (`apps/users/models.py`)**
   ...
   **Security Requirements:**
   - **Email Domain Restriction**: Only users with `@cccplc.net` email addresses can access the application
   - **Account Lockout**: After 5 consecutive failed login attempts, accounts are locked for 24 hours
   - **Login Attempt Tracking**: Users are notified of remaining attempts before lockout
   - **Admin Unlock**: Locked accounts require admin intervention or automatic unlock after 24 hours
