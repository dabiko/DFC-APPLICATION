  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      setAssessments([
        {
          id: '1',
          name: 'Q4 2024 KYC Assessment',
          description: 'Quarterly KYC compliance review',
          regulation: '1',
          regulation_name: 'KYC',
          assessment_type: 'internal',
          status: 'in_progress',
        ...
        },
        {
          ...
          description: 'Annual external audit for GDPR compliance',
          regulation: '3',
          regulation_name: 'GDPR',
          assessment_type: 'external',
          status: 'planned',
          scheduled_date: '2025-02-01',
          assessor_organization: 'External Auditors Ltd',
          finding_count: 0,
        ...
        {
          id: '3',
          name: 'Q3 2024 AML Review',
          description: 'Quarterly AML compliance review',
          regulation: '2',
          regulation_name: 'AML',
          assessment_type: 'internal',
          status: 'completed',
