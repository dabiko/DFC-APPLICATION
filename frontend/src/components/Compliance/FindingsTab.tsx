      ...
      setFindings([
        {
          ...
          description: 'Several customer documents do not have retention policies assigned.',
          severity: 'medium',
          status: 'open',
          regulation: '3',
          regulation_name: 'GDPR',
          risk_rating: 'medium',
          remediation_due_date: '2024-12-15',
        ...
        },
        {
          ...
          title: 'Incomplete KYC verification for 5 customers',
          description: 'Customer identity documents are missing or incomplete.',
          severity: 'high',
          status: 'in_progress',
          regulation: '1',
          regulation_name: 'KYC',
          risk_rating: 'high',
          remediation_due_date: '2024-11-30',
        ...
        },
        {
          ...
          title: 'Transaction monitoring gap detected',
          description: 'Certain transaction types are not being monitored for suspicious activity.',
          severity: 'critical',
          status: 'open',
          regulation: '2',
          regulation_name: 'AML',
          risk_rating: 'critical',
          remediation_due_date: '2024-11-20',
