      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <h2 id="create-folder-title" className="text-lg font-semibold text-gray-900 dark:text-gray-100">
              Create New Folder
            </h2>
          </div>
          <button
          ...
          <div className="px-6 py-4 space-y-4">
            ...
            {parentFolder && (
              <div className="text-sm text-gray-600 dark:text-gray-400">
                Creating folder in: <span className="font-medium text-gray-900 dark:text-gray-100">{parentFolder.path}</span>
              </div>
            )}
